...
Questa parte di codice rappresenta una **API** costruita utilizzando **FastAPI**, un framework moderno e performante per la creazione di API in Python. Di seguito vengono descritte le principali componenti del file.
